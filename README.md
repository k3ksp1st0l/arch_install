...
> ⚠️ **Внимание**:  
> Данный гайд описывает современную установку **Arch Linux** в режиме **UEFI** с полным шифрованием диска (**LUKS2**) и файловой системой **BTRFS**.
> Установка в режиме Legacy (BIOS/MBR) **не рассматривается**.
> 
